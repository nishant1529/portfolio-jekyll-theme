...
To begin, you will work in a similar ways, and the markdown files are easily created from Jupyter Notebooks. You are encouraged to adjust the example or another template that you find to begin a basic portfolio site for yourself.
